defmodule Ism4113Web.VendorControllerTest do
  use Ism4113Web.ConnCase

  alias Ism4113.Sales

  @create_attrs %{name: "some name", phone: 42, website: "some website"}
  ...
  def fixture(:vendor) do
    {:ok, vendor} = Sales.create_vendor(@create_attrs)
    vendor
  end
  ...
  describe "create vendor" do
    test "redirects to show when data is valid", %{conn: conn} do
      ...
      assert redirected_to(conn) == vendor_path(conn, :show, id)
